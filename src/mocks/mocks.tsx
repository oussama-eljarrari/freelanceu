 ...
 import { User, Gig, Order, Review, DashboardStats } from "../types/types"
...
export const mockOrders: Order[] = [
  ...
  },
  {
    ...
    price: 300,
    requirements:
      "E-commerce app with Stripe payments and product catalog.",
...
// M1 will replace this with real data from the auth token.
