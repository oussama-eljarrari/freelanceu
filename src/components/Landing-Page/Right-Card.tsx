...
const miniStats = [
  { label: "Orders completed", value: "5k+" },
  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      <div className="mt-8 flex flex-col gap-3 sm:flex-row">
        <Button
          size="lg"
          className="w-full sm:w-auto rounded-full px-8 shadow-lg shadow-primary/30"
      ...
      <div className="mt-14 flex items-end justify-between gap-6">
        <div>
          ...
          <p className="mt-4 max-w-52 text-sm leading-6 text-white/70">
            A simple marketplace interface designed to help people move from
            browsing to booking faster.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-4 backdrop-blur">
          ...
          <div className="mt-2 text-3xl font-semibold text-primary">+24%</div>
