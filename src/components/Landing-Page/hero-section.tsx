    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-4 py-16 sm:px-6 lg:grid-cols-[1.08fr_0.92fr] lg:px-8 lg:py-24">
        <div className="flex flex-col justify-center">
          ...
          <h1 className="max-w-xl text-balance text-5xl font-bold font-jakarta tracking-tight text-foreground sm:text-6xl lg:text-7xl">
            Work on your <span className="text-primary italic">terms</span>
          </h1>
